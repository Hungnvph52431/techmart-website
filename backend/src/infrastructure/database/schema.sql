...
CREATE TABLE order_returns (
    ...
    refund_destination ENUM('wallet', 'bank_account') NOT NULL DEFAULT 'wallet',
    refund_bank_account_id INT NULL,
    refund_bank_code VARCHAR(50) NULL,
    refund_bank_name VARCHAR(255) NULL,
    refund_account_number VARCHAR(50) NULL,
    refund_account_holder_name VARCHAR(255) NULL,
    refund_branch_name VARCHAR(255) NULL,
    status ENUM('requested', 'approved', 'rejected', 'received', 'refunded', 'closed') DEFAULT 'requested',
    reason TEXT NOT NULL,
    customer_note TEXT,
    evidence_images JSON NULL,
    admin_note TEXT,
    refund_receipt_image_url VARCHAR(500) NULL,
    refund_receipt_uploaded_at TIMESTAMP NULL,
    refund_receipt_uploaded_by INT NULL,
    ...
    FOREIGN KEY (refund_receipt_uploaded_by) REFERENCES users(user_id) ON DELETE SET NULL,
    INDEX idx_order (order_id),
    INDEX idx_status (status),
    INDEX idx_refund_destination (refund_destination),
...
CREATE TABLE wallet_withdrawal_requests (
    ...
    customer_note TEXT,
    admin_note TEXT,
    transfer_receipt_image_url VARCHAR(500) NULL,
    transfer_receipt_uploaded_at TIMESTAMP NULL,
    transfer_receipt_uploaded_by INT NULL,
    requested_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    approved_at TIMESTAMP NULL,
    ...
    FOREIGN KEY (transfer_receipt_uploaded_by) REFERENCES users(user_id) ON DELETE SET NULL,
