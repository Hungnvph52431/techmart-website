...
('iPhone 15 Pro Max', 'iphone-15-pro-max', 'IP15PM-001', 6, 1, 29990000, 28990000, 'iPhone 15 Pro Max - Đỉnh cao công nghệ với chip A17 Pro, camera 48MP, titan thiết kế', '{"screen": "6.7 inch", "chip": "A17 Pro", "ram": "8GB", "storage": ["256GB", "512GB", "1TB"], "camera": "48MP + 12MP + 12MP", "battery": "4422mAh"}', 50, 120, TRUE, TRUE, TRUE, 'active'),
('iPhone 14 Pro', 'iphone-14-pro', 'IP14P-001', 6, 1, 25990000, 24490000, 'iPhone 14 Pro - Chip A16 Bionic, Dynamic Island, camera 48MP', '{"screen": "6.1 inch", "chip": "A16 Bionic", "ram": "6GB", "storage": ["128GB", "256GB", "512GB"], "camera": "48MP + 12MP + 12MP", "battery": "3200mAh"}', 80, 250, TRUE, FALSE, TRUE, 'active'),
('iPhone 13', 'iphone-13', 'IP13-001', 6, 1, 17990000, 16990000, 'iPhone 13 - Hiệu năng mạnh mẽ, pin trâu, camera kép xuất sắc', '{"screen": "6.1 inch", "chip": "A15 Bionic", "ram": "4GB", "storage": ["128GB", "256GB", "512GB"], "camera": "12MP + 12MP", "battery": "3240mAh"}', 100, 450, TRUE, FALSE, TRUE, 'active'),
('Samsung Galaxy S24 Ultra', 'samsung-galaxy-s24-ultra', 'SS24U-001', 7, 2, 29990000, 28490000, 'Galaxy S24 Ultra - Snapdragon 8 Gen 3, camera 200MP, S Pen tích hợp', '{"screen": "6.8 inch", "chip": "Snapdragon 8 Gen 3", "ram": "12GB", "storage": ["256GB", "512GB", "1TB"], "camera": "200MP + 50MP + 12MP + 10MP", "battery": "5000mAh"}', 60, 180, TRUE, TRUE, TRUE, 'active'),
('Samsung Galaxy A54 5G', 'samsung-galaxy-a54-5g', 'SSA54-001', 7, 2, 9990000, 9490000, 'Galaxy A54 5G - Thiết kế cao cấp, màn hình 120Hz, camera 50MP', '{"screen": "6.4 inch", "chip": "Exynos 1380", "ram": "8GB", "storage": ["128GB", "256GB"], "camera": "50MP + 12MP + 5MP", "battery": "5000mAh"}', 150, 520, TRUE, FALSE, TRUE, 'active'),
('Samsung Galaxy Z Fold5', 'samsung-galaxy-z-fold5', 'SSZF5-001', 7, 2, 40990000, 38990000, 'Galaxy Z Fold5 - Điện thoại gập cao cấp, màn hình Dynamic AMOLED', '{"screen": "7.6 inch", "chip": "Snapdragon 8 Gen 2", "ram": "12GB", "storage": ["256GB", "512GB", "1TB"], "camera": "50MP + 12MP + 10MP", "battery": "4400mAh"}', 30, 85, TRUE, TRUE, FALSE, 'active'),
('Xiaomi 14 Pro', 'xiaomi-14-pro', 'XM14P-001', 8, 3, 19990000, 18990000, 'Xiaomi 14 Pro - Snapdragon 8 Gen 3, camera Leica, sạc nhanh 120W', '{"screen": "6.73 inch", "chip": "Snapdragon 8 Gen 3", "ram": "12GB", "storage": ["256GB", "512GB"], "camera": "50MP + 50MP + 50MP", "battery": "4880mAh"}', 70, 210, TRUE, TRUE, TRUE, 'active'),
('Xiaomi Redmi Note 13 Pro', 'xiaomi-redmi-note-13-pro', 'RN13P-001', 8, 3, 7990000, 7490000, 'Redmi Note 13 Pro - Camera 200MP, sạc nhanh 67W, pin 5000mAh', '{"screen": "6.67 inch", "chip": "Snapdragon 7s Gen 2", "ram": "8GB", "storage": ["128GB", "256GB"], "camera": "200MP + 8MP + 2MP", "battery": "5000mAh"}', 200, 850, TRUE, FALSE, TRUE, 'active'),
('OPPO Find X6 Pro', 'oppo-find-x6-pro', 'OPX6P-001', 9, 4, 22990000, 21990000, 'OPPO Find X6 Pro - Camera Hasselblad, Snapdragon 8 Gen 2', '{"screen": "6.82 inch", "chip": "Snapdragon 8 Gen 2", "ram": "12GB", "storage": ["256GB", "512GB"], "camera": "50MP + 50MP + 50MP", "battery": "5000mAh"}', 50, 95, TRUE, TRUE, FALSE, 'active'),
('OPPO Reno10 5G', 'oppo-reno10-5g', 'OPR10-001', 9, 4, 9490000, 8990000, 'OPPO Reno10 5G - Thiết kế mỏng nhẹ, camera chân dung chuyên nghiệp', '{"screen": "6.7 inch", "chip": "MediaTek Dimensity 7050", "ram": "8GB", "storage": ["256GB"], "camera": "64MP + 32MP + 8MP", "battery": "5000mAh"}', 120, 380, TRUE, FALSE, TRUE, 'active'),
('MacBook Air M2', 'macbook-air-m2', 'MBA-M2-001', 2, 1, 27990000, 26990000, 'MacBook Air M2 - Siêu mỏng nhẹ, chip M2 mạnh mẽ, pin 18 giờ', '{"screen": "13.6 inch", "chip": "Apple M2", "ram": "8GB", "storage": ["256GB", "512GB"], "graphics": "8-core GPU", "weight": "1.24kg"}', 40, 150, TRUE, FALSE, TRUE, 'active'),
('Dell XPS 13', 'dell-xps-13', 'DXP13-001', 2, 9, 32990000, 31490000, 'Dell XPS 13 - Thiết kế premium, màn hình InfinityEdge', '{"screen": "13.4 inch", "chip": "Intel Core i7-1355U", "ram": "16GB", "storage": ["512GB", "1TB"], "graphics": "Intel Iris Xe", "weight": "1.17kg"}', 35, 85, TRUE, FALSE, FALSE, 'active'),
('AirPods Pro 2', 'airpods-pro-2', 'APP2-001', 10, 1, 6490000, 5990000, 'AirPods Pro 2 - Chống ồn chủ động, âm thanh không gian', '{"type": "In-ear", "connection": "Bluetooth 5.3", "battery": "30 giờ", "features": ["Chống ồn ANC", "Âm thanh không gian", "Chống nước IPX4"]}', 200, 450, TRUE, FALSE, TRUE, 'active'),
('Samsung Galaxy Buds2 Pro', 'samsung-galaxy-buds2-pro', 'SGB2P-001', 10, 2, 4490000, 3990000, 'Galaxy Buds2 Pro - Âm thanh Hi-Fi 24bit, chống ồn thông minh', '{"type": "In-ear", "connection": "Bluetooth 5.3", "battery": "29 giờ", "features": ["Chống ồn ANC", "360 Audio", "Chống nước IPX7"]}', 150, 320, TRUE, FALSE, TRUE, 'active'),
('Anker PowerBank 20000mAh', 'anker-powerbank-20000mah', 'ANK-PB20-001', 11, 10, 990000, 890000, 'Sạc dự phòng Anker 20000mAh - Sạc nhanh 22.5W, 2 cổng USB', '{"capacity": "20000mAh", "input": "USB-C", "output": ["USB-C", "USB-A"], "fast_charge": "22.5W", "weight": "342g"}', 300, 1200, FALSE, FALSE, TRUE, 'active');
